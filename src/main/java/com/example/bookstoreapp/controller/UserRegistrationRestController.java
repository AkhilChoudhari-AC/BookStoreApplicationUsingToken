...
public class UserRegistrationRestController {
    ...
    //Autowired IUserRegistrationService to inject its dependency here
    @Autowired
...
// Ability to call api to add user registration data record
    @PostMapping("/add")
    public ResponseEntity<ResponseDTO> createUserRegistrationData(@Valid @RequestBody UserRegistrationDTO userRegistrationDTO) {
        ...
        EmailData emailData = new EmailData(userRegistrationData.getEmail(), "Successfully Registered",
                "Hello " + userRegistrationData.getFirstName() + " " +userRegistrationData.getLastName() +
    ...
    // Ability to call api to get all user registration data record
    @GetMapping("/getall")
    ...
    // Ability to call api to get user registration data record by email
    ...
    // Ability to call api to update user registration data record by token
    ...
    // Ability to call api to login the user
    ...
    // Ability to call api to verify the user registration data by token
