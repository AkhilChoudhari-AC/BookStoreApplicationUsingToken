...
@Service
//Creating EmailService class to serve api calls done by controller layer
public class EmailService implements IEmailService{
    ...
    public ResponseEntity<ResponseDTO> sendEmail(EmailData emailData) {
        final String fromEmail = "akhil.twity@gmail.com";
        final String fromPassword = "zpjdynkbnkkcyqta";
